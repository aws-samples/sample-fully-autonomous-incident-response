...
# Handle both cases: when role exists (returns Role dict) and when created (returns full response)
role_arn = agentcore_gateway_iam_role.get('Arn') or agentcore_gateway_iam_role.get('Role', {}).get('Arn')
